...
export class ResolutionQueryParams implements QueryParams {
    ...
    constructor(from?: number, to?: number, public geojson?: CustomGeoJson, public bbox?: BoundingBox, keywords?: string[], public includeConflict?: boolean) {
    ...
    dependsOnConflicts(): boolean {
      return (this.includeConflict || this.geojson  || this.bbox || this.keywords.length > 0) ? true : false;
    }
  };
